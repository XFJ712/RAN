  ...
  if (L1_ParamList.numelt > 0) {
    for (j = 0; j < RC.nb_nr_L1_inst; j++) {
      ...
      if(strcmp(*(L1_ParamList.paramarray[j][L1_TRANSPORT_N_PREFERENCE_IDX].strptr), "local_mac") == 0) {
        ...
        mac_top_init_gNB();
        configure_nfapi_pnf(RC.gNB[j][0]->eth_params_n.remote_addr, RC.gNB[j][0]->eth_params_n.remote_portc, RC.gNB[j][0]->eth_params_n.my_addr, RC.gNB[j][0]->eth_params_n.my_portd,
                            RC.gNB[j][0]->eth_params_n     .remote_portd);
      } else { // other midhaul
      }
    }// for (j = 0; j < RC.nb_nr_L1_inst; j++)
          ...
          for (j = 0; j < CCsParamList.numelt ; j++) {
            ...
            */
            ...
            if (strcmp(UL_SCS_SubcarrierSpacing,"kHz15")==0) {
              ...
              AssertFatal (0,"Failed to parse gNB configuration file %s, gnb %d unknown value \"%s\" for UL_SCS_SubcarrierSpacing choice: minusinfinity,kHz15,kHz30,kHz60,kHz120,kHz240!\n",
            ...
            if (strcmp(NIA_SubcarrierSpacing,"kHz15")==0) {
              ...
              AssertFatal (0,"Failed to parse gNB configuration file %s, gnb %d unknown value \"%s\" for NIA_SubcarrierSpacing choice: minusinfinity,kHz15,kHz30,kHz60,kHz120,kHz240!\n",
            ...
            if (strcmp(rach_ssb_perRACH_OccasionAndCB_PreamblesPerSSB_choice,"oneEighth")==0) {
              ...
              switch (rach_ssb_perRACH_OccasionAndCB_PreamblesPerSSB_oneEighth) {
                ...
                default:
                  AssertFatal (0,
                               "Failed to parse gNB configuration file %s, gnb %d unknown value \"%d\" for rach_ssb_perRACH_OccasionAndCB_PreamblesPerSSB_oneEighth choice: 4,8,12,16,20,24,28,32,36,40,44,48,52,56,60,64!\n",
              ...
              switch (rach_ssb_perRACH_OccasionAndCB_PreamblesPerSSB_oneFourth) {
                ...
                default:
                  AssertFatal (0,
                               "Failed to parse gNB configuration file %s, gnb %d unknown value \"%d\" for rach_ssb_perRACH_OccasionAndCB_PreamblesPerSSB_oneFourth choice: 4,8,12,16,20,24,28,32,36,40,44,48,52,56,60,64!\n",
              ...
              switch (rach_ssb_perRACH_OccasionAndCB_PreamblesPerSSB_oneHalf) {
                ...
                default:
                  AssertFatal (0,
                               "Failed to parse gNB configuration file %s, gnb %d unknown value \"%d\" for rach_ssb_perRACH_OccasionAndCB_PreamblesPerSSB_oneHalf choice: 4,8,12,16,20,24,28,32,36,40,44,48,52,56,60,64!\n",
              ...
              AssertFatal (0,
                           "Failed to parse gNB configuration file %s, gnb %d unknown value \"%s\" for rach_ssb_perRACH_OccasionAndCB_PreamblesPerSSB_choice: oneEighth,oneFourth,oneHalf,one,two,four,eight,sixteen !\n",
